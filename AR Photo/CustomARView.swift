...
class CustomARView: ARView {
    ...
    func changeFocusEntityColor(color:UIColor){
        focusEntity = FocusEntity(on: self, style: .classic(color: color))
    }
}
...
private extension CustomARView {
    ...
    func setupFocusEntity() {
        focusEntity = FocusEntity(on: self, style: .classic(color: UIColor.white))
